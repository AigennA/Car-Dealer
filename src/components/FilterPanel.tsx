  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow-sm sticky top-20">
      ...
      <button
        ...
        className="w-full bg-primary text-white py-2.5 rounded-lg hover:brightness-90 transition font-medium flex items-center justify-center gap-2 cursor-pointer"
      >
