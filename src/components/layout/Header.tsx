  ...
  return (
    <header className="bg-black text-white sticky top-0 z-50 border-b border-gray-800">
      <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
        ...
        <button
          type="button"
          className="md:hidden text-white hover:text-primary hover:bg-gray-800 active:bg-gray-700 focus-visible:ring-2 focus-visible:ring-primary transition-all duration-200 p-2 rounded-lg"
